...
def main():
    ...
    global test_prediction_output_file, output_folder
    output_folder = os.path.join(base_folder, "Output_201802161658")
    # default value
    ...
    parser = argparse.ArgumentParser(description='Copy image files to folders and its sub-folders according to prediciton results.')
